...
export default function MinumanPage() {
  ...
  const filteredRecipes = useMemo(() => {
    ...
    return filtered;
  }, [searchQuery, bahanFilter, allMinuman]);
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-12 rounded-2xl border border-slate-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all duration-200 bg-white/80 backdrop-blur-sm shadow-lg"
              />
            ...
            {showBahanFilter && (
              <div className="bg-white/80 backdrop-blur-sm border border-slate-300 rounded-2xl p-4 shadow-lg">
                <div className="mb-3">
                  ...
                  <input
                    type="text"
                    placeholder="Contoh: gula, jeruk, es, susu..."
                    value={bahanFilter}
                    onChange={(e) => setBahanFilter(e.target.value)}
                    className="w-full px-3 py-2 rounded-xl border border-slate-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all duration-200"
                  />
                </div>
              ...
              <button
                ...
                className={`flex items-center space-x-1 px-4 py-2 rounded-2xl border transition-all duration-200 ${
                  currentPage === 1
                    ...
                    : 'bg-white border-slate-300 text-slate-700 hover:bg-green-50 hover:border-green-300 hover:text-green-700'
                }`}
              >
